...
export default function MobileMenu({ menuOpen, setMenuOpen }) {
  return (
    <>
      {/* Overlay – kliknięcie poza menu je zamyka */}
      <div
      ...
      <aside
        className={`fixed top-0 right-0 h-full w-72 bg-[#d4edf8] shadow-xl z-50
      ...
      >
        ...
        <nav className="mt-16 p-6">
          <ul className="flex flex-col space-y-4 text-lg">
            <li>
              <Link href="/teraz-gramy" className="hover:text-blue-400" onClick={() => setMenuOpen(false)}>
                Teraz gramy
              </Link>
            </li>
            <li>
            ...
            <li>
              <a href="mailto:sedzia@mateuszbialy.pl" className="hover:text-blue-400 flex items-center space-x-2" onClick={() => setMenuOpen(false)}>
                <span>📧</span><span>sedzia@mateuszbialy.pl</span>
              </a>
            </li>
            <li>
              <a href="tel:781166101" className="hover:text-blue-400 flex items-center space-x-2" onClick={() => setMenuOpen(false)}>
